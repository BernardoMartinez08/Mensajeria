...
public class Messenger
{
    ...
    public bool conect_chatservice()
    {
        try
        {
            ...
            consumer = new EventingBasicConsumer(channel_whatsapp);
    ...
    public bool send_mesage(string message)
    {
        try
        {
            ...
            channel_messenger.BasicPublish(string.Empty, "messages_queue_messenger", null, encoded_message);
            Console.WriteLine("\nMESSAGE SENDED.\n\n");
            return true;
        }
        catch (Exception ex)
    ...
    public Task read_message()
    {
        try
        {
            ...
            channel_whatsapp.BasicConsume("messages_queue_whatsapp", true, consumer);
